...
import { FullScreen, Setting, Fold, Expand, Avatar, SwitchButton } from '@element-plus/icons-vue';
...
<template>
    <el-menu mode="horizontal" :ellipsis="false">
        ...
        <el-menu-item class="increase-spacing" @click="showClick">
            <el-dropdown ref="dropdown" trigger="contextmenu" @command="avatarHandleCommand">
